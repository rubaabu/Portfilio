...
$menuLinks = '<li class="nav-item active mr-5">
              ...
              <li class="nav-item mr-5">
              <a class="font nav-link" href="admpanel.php">Dashboard</a>
              </li>
...
<nav class="navbar navbar-expand-lg p-0" id="navbar">
    <a href="home.php" class="font"><img src="src/img/logo.jpg" class="rounded img-fluid mr-5" alt="logo" height="50" width="70"></a>
    ...
    <div class="collapse navbar-collapse" id="navbarcontent">
      ...
      <div class="ml-auto">      
      <a class="mr-3 font " href="logout.php"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Log out</a>
